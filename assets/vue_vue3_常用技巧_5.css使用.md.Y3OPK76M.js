import{_ as s,c as i,o as a,a3 as n}from"./chunks/framework.BvVpiGod.js";const c=JSON.parse('{"title":"css使用","description":"","frontmatter":{},"headers":[],"relativePath":"vue/vue3/常用技巧/5.css使用.md","filePath":"vue/vue3/常用技巧/5.css使用.md","lastUpdated":1652970030000}'),l={name:"vue/vue3/常用技巧/5.css使用.md"},p=n(`<h1 id="css使用" tabindex="-1">css使用 <a class="header-anchor" href="#css使用" aria-label="Permalink to &quot;css使用&quot;">​</a></h1><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">Vue SFC(Vue单文件组件)</span></span>
